...
OUTPUT_PATH = r"C:\Users\vilke\OneDrive\Dokumentai\thesis_project\output\portfolios\portfolio_weights_capped.csv"
...
# ============================================================
# 5. Create capped portfolio weights
# ============================================================
...
for current_date in portfolio_dates:
    ...
    for model in models:
        ...
        for cap in weight_caps:
            ...
            model_name = f"{model}_cap_{int(cap * 100)}"
...
print("Capped portfolio weights saved successfully.")
