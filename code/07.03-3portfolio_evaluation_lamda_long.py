...
OUTPUT_PATH = r"C:\Users\vilke\OneDrive\Dokumentai\thesis_project\output\portfolios\portfolio_performance_lambda_long_only.csv"
...
for (model, base_model, lam), df in data.groupby(
...
print("Lambda long-only portfolio performance saved successfully.")
print(results_df)
print("\nSaved as portfolio_performance_lambda_long_only.csv")