...
OUTPUT_PATH = r"C:\Users\vilke\OneDrive\Dokumentai\thesis_project\output\portfolios\portfolio_returns_capped.csv"
...
# ============================================================
# 4. Create capped portfolio returns
# ============================================================
...
for current_date in portfolio_dates:
    ...
    # Group by model and cap because same model name may have cap information
...
print("Capped portfolio returns saved successfully.")
