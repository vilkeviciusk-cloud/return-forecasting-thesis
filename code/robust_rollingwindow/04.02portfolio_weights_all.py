...
FORECAST_PATH = ROBUSTNESS_DIR / "combined_forecasts_rolling_240_for_portfolio_with_rf.csv"
COV_PATH = ROBUSTNESS_DIR / "covariance_matrices_rolling_240.csv"

OUTPUT_PATH = ROBUSTNESS_DIR / "portfolio_weights_rolling_cap20_with_rf.csv"
...
print("Rolling cap-20 portfolio weights with RF saved successfully.")
