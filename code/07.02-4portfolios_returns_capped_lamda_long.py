...
OUTPUT_PATH = r"C:\Users\vilke\OneDrive\Dokumentai\thesis_project\output\portfolios\portfolio_returns_cap_lambda.csv"
...
# Make cap/lambda easier to group
...
for current_date in portfolio_dates:
    ...
    for keys, group in weights_month.groupby(group_cols, dropna=False):
        ...
        # Make sure each group has one row per asset
        available_assets = set(group["asset"])
...
print("Cap + lambda portfolio returns saved successfully.")
