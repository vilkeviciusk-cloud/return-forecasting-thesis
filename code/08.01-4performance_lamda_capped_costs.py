...
WEIGHTS_PATH = r"C:\Users\vilke\OneDrive\Dokumentai\thesis_project\output\portfolios\portfolio_weights_cap_lambda.csv"
...
OUTPUT_PATH = OUTPUT_DIR / "portfolio_performance_cap_lambda_after_costs.csv"
    ...
    for current_date in sorted(group["date"].unique()):
        ...
        if len(missing_assets) > 0:
            print(
                ...
                f"model={model}, cap={cap}, lambda={lam}, "
...
results_data = returns.merge(
    turnover,
    on=["date", "model", "base_model", "cap", "lambda"],
    how="left"
)
...
print("After-cost cap + lambda portfolio performance saved.")
print(results_df)
